...
flags = tf.app.flags
FLAGS = flags.FLAGS
tf.flags.DEFINE_string("config_paths", default="config-train-production.yaml",
...
flags.DEFINE_string('validation_path', default='data/imitation_learning/preprocessed/VAL*.tfrecord.gz',
                    help='List of paths containing the validation data to use, as '
                         'glob-style patterns.')
flags.DEFINE_integer('train_steps', default=450000,
...
flags.DEFINE_integer('save_checkpoints_steps', default=10000,
